...
class PrivateNetv6 extends BaseNetworkRule
{
    public function doValidation(string $attribute, string $value, ...$parameters): bool
    {
        ...
        return Util::validPrivateIPv6Network($value, $this->minBits, $this->maxBits);
    }

    public function message(): string
    {
        $message = __('The :attribute field must be a private IPv6 network in CIDR notation');
        if (!$this->extended) {
